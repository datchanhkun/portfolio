            ...
            <div className='project-frameworks'>
              {p.frameworks && p.frameworks.map((fr, index) => (
                <div className='framework' key={index}>
                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" aria-hidden="true" className="text-projecs-arrow"><path stroke-linecap="round" stroke-linejoin="round" d="M13 7l5 5m0 0l-5 5m5-5H6"></path>
                  </svg>
                  <p>{fr}</p>
                </div>
              ))}
                ...
                <button className={p.github === '' ? 'disabled-button' : 'externalLinkButton-button'}>
                  <span className='externalLinkButton-buttonContent'>
                    ...
                    <div className='arrow-animation'>
                      <svg fill="none" height="20" stroke="currentColor" stroke-linecap="square" stroke-linejoin="inherit" stroke-width="1" viewBox="0 0 24 24" width="20" xmlns="http://www.w3.org/2000/svg" className="externalLinkButton-Icon"><path d="M5 12h13M12 5l7 7-7 7"></path></svg>
                  </div>
                  </span>
                </button>
              </a>
